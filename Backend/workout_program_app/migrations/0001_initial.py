# Generated by Django 4.2.4 on 2023-09-06 21:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workouts', models.ManyToManyField(related_name='workout_programs', to='workout_app.workout')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userWorkoutPrograms', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
